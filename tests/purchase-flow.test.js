...
describe('guided purchase flow', () => {
  ...
  test('shows the floating app installer on all browsers and keeps sw v54 installable', () => {
    const html = readHtml();
    ...
    expect(html).toContain("const CACHE_NAME = 'aswa-v54'");
    ...
    expect(sw).toContain("const CACHE_NAME = 'aswa-v54'");
